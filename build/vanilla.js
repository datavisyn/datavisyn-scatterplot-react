...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var d3_axis_1 = __webpack_require__(4);
	var d3scale = __webpack_require__(5);
	var d3_selection_1 = __webpack_require__(13);
	var d3_zoom_1 = __webpack_require__(14);
	var d3_quadtree_1 = __webpack_require__(20);
	var symbol_1 = __webpack_require__(21);
	var _symbol = __webpack_require__(21);
	var merge_1 = __webpack_require__(24);
	var quadtree_1 = __webpack_require__(25);
	var lasso_1 = __webpack_require__(26);
	/**
	 * a class for rendering a scatterplot in a canvas
	 */
	var Scatterplot = (function () {
	    function Scatterplot(data, parent, options) {
	        var _this = this;
	        this.parent = parent;
	        /**
	         * x scale applied to value
	         */
	        this.xscale = d3scale.scaleLinear().domain([0, 100]);
	        /**
	         * y scale applied to valuee
	         */
	        this.yscale = d3scale.scaleLinear().domain([0, 100]);
	        this.symbol = symbol_1.circleSymbol();
	        this.options = {
	            margin: {
	                left: 40,
	                top: 10,
	            ...
	            tooltipDelay: 300,
	            tooltip: function (d) { return JSON.stringify(d); }
	        };
	        this.zoom = d3_zoom_1.zoom().on('zoom', this.onZoom.bind(this)).on('end', this.onZoomEnd.bind(this));
	        this.showTooltipHandle = -1;
	        this.lasso = new lasso_1.default();
	        ...
	        this.canvas = parent.children[0];
	        //register zoom
	        this.zoom
	            .scaleExtent(this.options.scaleExtent);
	        d3_selection_1.select(this.canvas)
	            .call(this.zoom)
	            .on('click', function () { return _this.onClick(d3_selection_1.event); })
	            .on('mouseleave', function () { return _this.onMouseLeave(d3_selection_1.event); })
	            .on('mousemove', function () { return _this.onMouseMove(d3_selection_1.event); });
	        //generate a quad tree out of the data
	        this.tree = d3_quadtree_1.quadtree(data, this.options.x, this.options.y);
	        this._selection = d3_quadtree_1.quadtree([], this.options.x, this.options.y);
	    }
	    ...
	    Object.defineProperty(Scatterplot.prototype, "ctx", {
	        get: function () {
	    ...
	    Scatterplot.prototype.onSelectionChanged = function (self) {
	        // hook dummy
	    };
	    Object.defineProperty(Scatterplot.prototype, "selection", {
	        ...
	        set: function (selection) {
	            ...
	            selection.forEach(function (s_new) {
	                var i = s.indexOf(s_new);
	                if (i < 0) {
	                    _this._selection.add(s_new);
	                    changed = true;
	                }
	                else {
	    ...
	    Scatterplot.prototype.transformedScales = function () {
	        var transform = d3_zoom_1.zoomTransform(this.canvas);
	        var xscale = transform.rescaleX(this.xscale);
	        var yscale = transform.rescaleY(this.yscale);
	        return { xscale: xscale, yscale: yscale };
	    };
	    Scatterplot.prototype.render = function () {
	        var c = this.canvas, ctx = this.ctx, margin = this.options.margin, bounds = { x0: margin.left, y0: margin.top, x1: c.clientWidth - margin.right, y1: c.clientHeight - margin.bottom };
	        this.checkResize();
	    ...
	    Object.defineProperty(Scatterplot.prototype, "clickRadius", {
	        get: function () {
	            // FIXME 
	            //compute the data domain radius based on xscale and the scaling factor
	            var view = this.options.clickRadius;
	            var transform = d3_zoom_1.zoomTransform(this.canvas);
	            //tranform from view to data without translation
	            var data = this.xscale.invert(view / transform.k + this.options.margin.left);
	    ...
	    Scatterplot.prototype.onClick = function (event) {
	        var _a = this.getMouseDataPos(), x = _a.x, y = _a.y;
	        //find closest data item
	        //TODO implement a find all to select more than one item
	        var closest = quadtree_1.findAll(this.tree, x, y, this.clickRadius);
	        this.selection = closest;
	    };
	    Scatterplot.prototype.getMouseDataPos = function (pos) {
	        if (pos === void 0) { pos = d3_selection_1.mouse(this.canvas); }
	        var _a = this.transformedScales(), xscale = _a.xscale, yscale = _a.yscale;
	        return { x: xscale.invert(pos[0]), y: yscale.invert(pos[1]) };
	    };
	    Scatterplot.prototype.showTooltip = function (pos) {
	        //highlight selected item
	        var _a = this.getMouseDataPos(pos), x = _a.x, y = _a.y;
	        var items = quadtree_1.findAll(this.tree, x, y, this.clickRadius);
	    ...
	    Scatterplot.prototype.onMouseMove = function (event) {
	        ...
	        var pos = d3_selection_1.mouse(this.canvas);
	    ...
	    Scatterplot.prototype.renderAxes = function (xscale, yscale) {
	        var left = d3_axis_1.axisLeft(yscale), bottom = d3_axis_1.axisBottom(xscale), $parent = d3_selection_1.select(this.parent);
	        $parent.select('svg g').call(left);
	        $parent.select('svg:last-of-type g').call(bottom);
	    };
	    Scatterplot.prototype.renderPoints = function (ctx, xscale, yscale, bounds) {
	        var _a = this.options, x = _a.x, y = _a.y;
	        var renderer = null;
	        function debugNode(color, x0, y0, x1, y1) {
	            ctx.closePath();
	        ...
	        var isVisible = quadtree_1.hasOverlap(xscale.invert(bounds.x0), 
	        /*since y domain is inverted*/
	        yscale.invert(bounds.y1), xscale.invert(bounds.x1), yscale.invert(bounds.y0));
	        function visitTree(node, x0, y0, x1, y1) {
	            if (quadtree_1.isLeafNode(node)) {
	                quadtree_1.forEach(node, function (d) { return renderer.render(xscale(x(d)), yscale(y(d)), d); });
	        ...
	        ctx.save();
	        renderer = this.symbol(ctx, symbol_1.ERenderMode.NORMAL);
	        this.tree.visit(visitTree);
	        renderer.done();
	        //render selected - TODO maybe in own canvas for performance of selection changes
	        renderer = this.symbol(ctx, symbol_1.ERenderMode.SELECTED);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   true ? factory(exports, __webpack_require__(15), __webpack_require__(16), __webpack_require__(8), __webpack_require__(13), __webpack_require__(17)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   true ? factory(exports, __webpack_require__(15), __webpack_require__(13)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   true ? factory(exports, __webpack_require__(13), __webpack_require__(15), __webpack_require__(18), __webpack_require__(8), __webpack_require__(9), __webpack_require__(19)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var d3_shape_1 = __webpack_require__(22);
	...
	var ERenderMode = exports.ERenderMode;
	/**
	...
	function d3Symbol(symbol, fillStyle, size) {
	    if (symbol === void 0) { symbol = exports.d3SymbolCircle; }
	...
	exports.d3SymbolCircle = d3_shape_1.symbolCircle;
	exports.d3SymbolCross = d3_shape_1.symbolCross;
	exports.d3SymbolDiamond = d3_shape_1.symbolDiamond;
	exports.d3SymbolSquare = d3_shape_1.symbolSquare;
	exports.d3SymbolStar = d3_shape_1.symbolStar;
	exports.d3SymbolTriangle = d3_shape_1.symbolTriangle;
	exports.d3SymbolWye = d3_shape_1.symbolWye;
...
/***/ function(module, exports) {
	...
	function findAll(tree, x, y, radius) {
	    if (radius === void 0) { radius = Infinity; }
	    var r = [];
	    var adder = r.push.bind(r);
	    var radius2 = radius * radius;
	    //bounding of search radius
	    var overlapping = hasOverlap(x - radius, y - radius, x + radius, y + radius);
	    function inDistance(x1, y1) {
	        var dx = x1 - x;
	        var dy = y1 - y;
	        return (dx * dx + dy * dy) <= radius2;
	    }
	    function findItems(node, x0, y0, x1, y1) {
	        var xy00In = inDistance(x0, y0);
	        var xy01In = inDistance(x0, y1);
	        var xy10In = inDistance(x1, y0);
	        var xy11In = inDistance(x1, y1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lasso = (function () {
	    function Lasso() {
	        this.line = d3_shape_1.line().curve(d3_shape_1.curveCardinalClosed);
	        this.points = [[100, 100], [200, 200], [100, 300]];
	    }
